...
fn test_pod_persistence() {
    ...
    assert!(load_after_delete.is_err(), "Pod info should not exist after deletion");
...
fn test_pod_error_handling() {
    ...
    assert!(state_result.is_ok(), "State command on nonexistent pod should handle gracefully");
    ...
    assert!(start_result.is_ok(), "Start command on nonexistent pod should handle gracefully");
    ...
    assert!(delete_result.is_ok(), "Delete command on nonexistent pod should be idempotent");
...
fn test_invalid_pod_config() {
    ...
    assert!(create_result.is_ok(), "Create command with invalid config should handle errors gracefully");
    ...
    assert!(run_result.is_ok(), "Run command with invalid config should handle errors gracefully");
